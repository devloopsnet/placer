package net.devloops.placer.legacy.location;
...
import net.devloops.placer.location.GooglePlacesAutocompleteAdapter;
import net.devloops.placer.location.LocationEntity;
